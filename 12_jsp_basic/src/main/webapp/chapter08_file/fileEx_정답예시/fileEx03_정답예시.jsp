...
<body>
	...
	<form action="fileEx03_정답예시" method="post" enctype="multipart/form-data">
		<fieldset>
			<legend>파일 업로드</legend>
			<p>업로더 : <input type="text" name="uploader" /></p>
			<p>파일 1 : <input type="file" name="uploadFile1" /></p>
			<p>파일 2 : <input type="file" name="uploadFile2" /></p>
			<p>파일 3 : <input type="file" name="uploadFile3" /></p>
